...
𐙚 Фильтры по году и жанру <br>
𐙚 Анализ сюжета и отзывов (NLP) <br>
𐙚 Определение жанра по постеру (Компьютерное зрение) <br>
𐙚 Поиск похожих фильмов через векторные представления (эмбеддинги) <br>
